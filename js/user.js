  ...
  _userPageDom = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            id = _args2.length > 0 && _args2[0] !== undefined ? _args2[0] : 1;
            _context2.next = 3;
...
function generatePostsList(userDataToDom) {
  ...
  var obj = {
    header: "User name: ".concat(userDataToDom.name),
    list: ["User full name: ".concat(userDataToDom.username), userDataToDom.email, "<a href=\"https://maps.google.com/?q=".concat(userDataToDom.address.lat, ",").concat(userDataToDom.address.lng, "\">").concat(userDataToDom.address.address, "</a>"), "User phone: ".concat(userDataToDom.phone), "User website: ".concat(userDataToDom.website), "User job name: ".concat(userDataToDom.company)]
  };
