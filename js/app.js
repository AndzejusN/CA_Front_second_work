...
function generatePostsList(postData) {
  ...
  var divCard = (0,_functions__WEBPACK_IMPORTED_MODULE_1__.createDomElement)('div', '', "card post-id-".concat(postData.id, " card-parameters"));
  leftColumn.append(divCard);
  var divCardHeader = (0,_functions__WEBPACK_IMPORTED_MODULE_1__.createDomElement)('div', "Post id:".concat(postData.id), 'card-header');
  ...
  divCard.append(ul);
  var liFirst = (0,_functions__WEBPACK_IMPORTED_MODULE_1__.createDomElement)('li', "Post title:".concat((0,_functions__WEBPACK_IMPORTED_MODULE_1__.firstLetterToUpperCase)(postData.title)), 'list-group-item');
  ul.append(liFirst);
  var liSecond = (0,_functions__WEBPACK_IMPORTED_MODULE_1__.createDomElement)('li', "Post content: ".concat((0,_functions__WEBPACK_IMPORTED_MODULE_1__.firstLetterToUpperCase)(postData.body)), 'list-group-item');
  ul.append(liSecond);
  var liThird = (0,_functions__WEBPACK_IMPORTED_MODULE_1__.createDomElement)('li', "User name: ".concat(postData.username), 'list-group-item');
...
function addPostComments(commentsList) {
  ...
  var divCardHeaderComment = (0,_functions__WEBPACK_IMPORTED_MODULE_1__.createDomElement)('div', "Comment header: ".concat((0,_functions__WEBPACK_IMPORTED_MODULE_1__.firstLetterToUpperCase)(commentsList.name)), 'card-header');
  ...
  var liFirstComment = (0,_functions__WEBPACK_IMPORTED_MODULE_1__.createDomElement)('li', "Comment content: ".concat((0,_functions__WEBPACK_IMPORTED_MODULE_1__.firstLetterToUpperCase)(commentsList.body)), 'list-group-item');
  ulComment.appendChild(liFirstComment);
  var liSecondComment = (0,_functions__WEBPACK_IMPORTED_MODULE_1__.createDomElement)('li', "Author e-mail address: ".concat(commentsList.email), 'list-group-item');
...
function _getPosts() {
  _getPosts = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    var data;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return (0,_functions__WEBPACK_IMPORTED_MODULE_1__.fetchData)('https://jsonplaceholder.typicode.com/posts?_limit=10&_embed=comments&_expand=user');
          case 2:
            data = _context2.sent;
...
function albumsList() {
  return _albumsList.apply(this, arguments);
}
function _albumsList() {
  _albumsList = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
    var data;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _context3.next = 2;
            return (0,_functions__WEBPACK_IMPORTED_MODULE_1__.fetchData)('https://jsonplaceholder.typicode.com/albums?_expand=user&_embed=photos');
          case 2:
            data = _context3.sent;
...
function generateAlbumsList(albumsDataToDom) {
  ...
  var obj = {
    header: "<strong>Albumo pavadinimas: <a href=\"album.html?albumid=".concat(albumsDataToDom.albumId, "\">").concat((0,_functions__WEBPACK_IMPORTED_MODULE_1__.firstLetterToUpperCase)(albumsDataToDom.title), "</a></strong>"),
    list: ["Albumo id: ".concat(albumsDataToDom.albumId), "Vartotojo id: ".concat(albumsDataToDom.userId), "Vartotojo vardas/pavard\u0117: ".concat(albumsDataToDom.userName), "<img src=\"".concat(albumsDataToDom.photo, "\">")]
  };
