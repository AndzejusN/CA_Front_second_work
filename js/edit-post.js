...
function init() {
  var postId = (0,_functions__WEBPACK_IMPORTED_MODULE_1__.getSearchPhrase)('postid');
...
function _getData() {
  _getData = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(postId) {
    var error, data;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            if (!postId) {
              error = (0,_functions__WEBPACK_IMPORTED_MODULE_1__.createDomElement)('h5', 'Something went wrong, try one more time');
              document.body.prepend(error);
            }
            _context2.next = 3;
            return (0,_functions__WEBPACK_IMPORTED_MODULE_1__.fetchData)("https://jsonplaceholder.typicode.com/posts/".concat(postId, "?_expand=user"));
          case 3:
            data = _context2.sent;
...
function setDataUsersNamesSelect(_x2) {
  return _setDataUsersNamesSelect.apply(this, arguments);
}
function _setDataUsersNamesSelect() {
  _setDataUsersNamesSelect = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(userId) {
    var select, data;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            select = document.getElementById('user-id');
            _context3.next = 3;
            return (0,_functions__WEBPACK_IMPORTED_MODULE_1__.fetchData)('https://jsonplaceholder.typicode.com/users');
          case 3:
            data = _context3.sent;
...
function getDataForm(postId) {
  ...
  form.addEventListener('submit', /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(event) {
      var postName, postBody, selectUserId, data, response;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              event.preventDefault();
              postName = event.target.elements['post-name'].value;
              postBody = event.target.elements['post-body'].value;
              selectUserId = event.target.elements['user-id'].value;
              data = {
                id: postId,
                title: postName,
                body: postBody,
              ...
              _context.next = 7;
              return (0,_functions__WEBPACK_IMPORTED_MODULE_1__.fetchData)("https://jsonplaceholder.typicode.com/posts/".concat(postId), data, 'PUT');
            case 7:
...
function infoToHtml(responseData) {
  var rigthColumn = document.querySelector('.right-column');
  rigthColumn.innerHTML = '';
  var response = document.createElement('h6');
  response.innerText = "Post id:  ".concat(responseData.id, ";\n                          User id: ").concat(responseData.userId, ";\n                          Post title: ").concat((0,_functions__WEBPACK_IMPORTED_MODULE_1__.firstLetterToUpperCase)(responseData.title), ";\n                          Post text: ").concat((0,_functions__WEBPACK_IMPORTED_MODULE_1__.firstLetterToUpperCase)(responseData.body), ";");
