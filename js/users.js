...
function userPageDom(_x) {
  return _userPageDom.apply(this, arguments);
}
function _userPageDom() {
  _userPageDom = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(userId) {
    var container, currentPage, numberPerPage, data, total, res, _res, dataToPagination;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
...
function generatePostsList(userDataToDom) {
  ...
  var obj = {
    header: "<a href=\"user.html?userid=".concat(userDataToDom.id, "\">").concat(userDataToDom.name, "</a>"),
    list: [userDataToDom.username, userDataToDom.email, "<a href=\"https://maps.google.com/?q=".concat(userDataToDom.address.lat, ",").concat(userDataToDom.address.lng, "\">").concat(userDataToDom.address.address, "</a>"), userDataToDom.phone, userDataToDom.website, userDataToDom.company, "<a href=\"edit-user.html?userid=".concat(userDataToDom.id, "\">Edit user information</a>")]
  };
