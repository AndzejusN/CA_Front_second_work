  ...
  _init = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            inputSearch = (0,_functions__WEBPACK_IMPORTED_MODULE_1__.getSearchPhrase)('inputSearch');
            _context.next = 3;
            return searchBy(inputSearch);
          case 3:
            fromSearch();
            (0,_header_js__WEBPACK_IMPORTED_MODULE_0__["default"])();
            (0,_functions__WEBPACK_IMPORTED_MODULE_1__.waitingForDataSpinner)();
          case 6:
          case "end":
            return _context.stop();
        }
...
function fromSearch() {
  var innerSearchForm = document.querySelector('#search-form-inner');
  innerSearchForm.addEventListener('submit', function (e) {
    e.preventDefault();
    (0,_functions__WEBPACK_IMPORTED_MODULE_1__.waitingForDataSpinner)();
    var searchValue = e.target.innerInput.value;
    searchBy(searchValue);
    innerSearchForm.reset();
    (0,_functions__WEBPACK_IMPORTED_MODULE_1__.waitingForDataSpinner)();
  });
}
function searchBy(_x) {
  return _searchBy.apply(this, arguments);
}
function _searchBy() {
  _searchBy = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(inputSearch) {
    var firstColumn, secondColumn, thirdColumn, fourthColumn;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            firstColumn = document.querySelector('.first-column');
            secondColumn = document.querySelector('.second-column');
            thirdColumn = document.querySelector('.third-column');
            fourthColumn = document.querySelector('.fourth-column');
            _context2.next = 6;
            return searchFetch(firstColumn, 'users', inputSearch);
          case 6:
            _context2.next = 8;
            return searchFetch(secondColumn, 'posts', inputSearch);
          case 8:
            _context2.next = 10;
            return searchFetch(thirdColumn, 'albums', inputSearch);
          case 10:
            _context2.next = 12;
            return searchFetch(fourthColumn, 'comments', inputSearch);
          case 12:
          case "end":
            return _context2.stop();
        }
...
function searchFetch(_x2, _x3, _x4) {
  return _searchFetch.apply(this, arguments);
}
function _searchFetch() {
  _searchFetch = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(column, searchBy, parameter) {
    var cuttedLastSimbol, res, data, h6, textToHtml;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            cuttedLastSimbol = searchBy.slice(0, searchBy.length - 1);
            _context3.next = 3;
            return (0,_functions__WEBPACK_IMPORTED_MODULE_1__.fetchData)("https://jsonplaceholder.typicode.com/".concat(searchBy, "?q=").concat(parameter));
          case 3:
            res = _context3.sent;
            data = res.data;
            column.innerHTML = '';
            if (data.length < 1) {
              ...
              h6.innerHTML = '';
              textToHtml = 'No data in ' + searchBy + ' was found';
              ...
              data.map(function (element) {
                ...
                var divCard = (0,_functions__WEBPACK_IMPORTED_MODULE_1__.createDomElement)('div', '', 'card card-parameters mx-auto dom-created-data');
                column.append(divCard);
                var textToHtmlHeader = "Title: <a href=\"".concat(cuttedLastSimbol, ".html?").concat(cuttedLastSimbol, "id=").concat(element.id, "\">").concat((0,_functions__WEBPACK_IMPORTED_MODULE_1__.firstLetterToUpperCase)(element.title), "</a>");
                var divCardHeader = document.createElement('div', textToHtmlHeader, 'card-header');
                divCard.appendChild(divCardHeader);
                var ul = (0,_functions__WEBPACK_IMPORTED_MODULE_1__.createDomElement)('ul', '', 'list-group list-group-flush');
                divCard.appendChild(ul);
                var liPostId = (0,_functions__WEBPACK_IMPORTED_MODULE_1__.createDomElement)('li', "Id: ".concat(element.id), 'list-group-item');
