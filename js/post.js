  ...
  _init = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            inputSearch = (0,_functions__WEBPACK_IMPORTED_MODULE_1__.getSearchPhrase)('postid');
            _context.next = 3;
            return getOnePost(inputSearch);
          case 3:
            _context.next = 5;
            return formCreatePostComment(inputSearch);
          case 5:
...
function getOnePost() {
  return _getOnePost.apply(this, arguments);
}
function _getOnePost() {
  _getOnePost = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    var post,
      res,
      postData,
      postsDataToDom,
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            post = _args2.length > 0 && _args2[0] !== undefined ? _args2[0] : 1;
            _context2.next = 3;
            return (0,_functions__WEBPACK_IMPORTED_MODULE_1__.fetchData)("https://jsonplaceholder.typicode.com/posts/".concat(post, "/?_expand=user&_embed=comments"));
          case 3:
            res = _context2.sent;
            postData = res.data;
            postsDataToDom = {
...
function generatePostsList(postsDataToDom) {
  ...
  var divCard = (0,_functions__WEBPACK_IMPORTED_MODULE_1__.createDomElement)('div', '', "card card-parameters post-id-".concat(postsDataToDom.id));
  leftColumn.append(divCard);
  var headerTextToHtml = "Post title: <a href=\"#\">".concat((0,_functions__WEBPACK_IMPORTED_MODULE_1__.firstLetterToUpperCase)(postsDataToDom.title), "</a>");
  var divCardHeader = (0,_functions__WEBPACK_IMPORTED_MODULE_1__.createDomElement)('div', headerTextToHtml, 'card-header');
  divCard.appendChild(divCardHeader);
  var ul = (0,_functions__WEBPACK_IMPORTED_MODULE_1__.createDomElement)('ul', '', 'list-group list-group-flush');
  divCard.appendChild(ul);
  var liUsername = (0,_functions__WEBPACK_IMPORTED_MODULE_1__.createDomElement)('li', "Post content: ".concat((0,_functions__WEBPACK_IMPORTED_MODULE_1__.firstLetterToUpperCase)(postsDataToDom.body)), 'list-group-item');
  ul.appendChild(liUsername);
  var liPostId = (0,_functions__WEBPACK_IMPORTED_MODULE_1__.createDomElement)('li', "Post id: ".concat(postsDataToDom.postId), 'list-group-item');
  ul.appendChild(liPostId);
  var liUserId = (0,_functions__WEBPACK_IMPORTED_MODULE_1__.createDomElement)('li', "User id: ".concat(postsDataToDom.userId), 'list-group-item');
  ul.appendChild(liUserId);
  var listTextToHtml = "User name: <a href=\"user.html?userid=".concat(postsDataToDom.userId, "\">").concat(postsDataToDom.username, "</a>");
  var liUserName = (0,_functions__WEBPACK_IMPORTED_MODULE_1__.createDomElement)('li', listTextToHtml, 'list-group-item');
  ul.appendChild(liUserName);
  var liUserAllPosts = (0,_functions__WEBPACK_IMPORTED_MODULE_1__.createDomElement)('li', "<a href=\"posts.html\">Kiti autoriaus \u012Fra\u0161ai</a>", 'list-group-item');
  ul.appendChild(liUserAllPosts);
}
function addPostComments(commentsList) {
  var postById = document.querySelector(".post-id-".concat(commentsList.postId));
  var divCardComment = document.createElement('div');
  ...
  var divCardHeaderComment = (0,_functions__WEBPACK_IMPORTED_MODULE_1__.createDomElement)('div', commentsList.name, 'card-header');
  divCardComment.appendChild(divCardHeaderComment);
  var ulComment = (0,_functions__WEBPACK_IMPORTED_MODULE_1__.createDomElement)('ul', '', 'list-group list-group-flush');
  divCardHeaderComment.appendChild(ulComment);
  var liFirstComment = (0,_functions__WEBPACK_IMPORTED_MODULE_1__.createDomElement)('li', (0,_functions__WEBPACK_IMPORTED_MODULE_1__.firstLetterToUpperCase)(commentsList.body), 'list-group-item');
  ulComment.appendChild(liFirstComment);
  var liSecondComment = (0,_functions__WEBPACK_IMPORTED_MODULE_1__.createDomElement)('li', commentsList.email, 'list-group-item');
  ulComment.appendChild(liSecondComment);
}
function formCreatePostComment(_x) {
  return _formCreatePostComment.apply(this, arguments);
}
function _formCreatePostComment() {
  _formCreatePostComment = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(postId) {
    var formCreateComment;
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            formCreateComment = document.querySelector('.comment-form');
            formCreateComment.addEventListener('submit', /*#__PURE__*/function () {
              var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(event) {
                var name, email, body, data, res, response, commentList;
                return _regeneratorRuntime().wrap(function _callee3$(_context3) {
                  while (1) {
                    switch (_context3.prev = _context3.next) {
                      case 0:
                        event.preventDefault();
                        name = event.target.elements['comment-name'].value;
                        email = event.target.elements['comment-email'].value;
                        body = event.target.elements['comment-body'].value;
                        data = {
                          postId: postId,
                          name: name,
                          email: email,
                        ...
                        _context3.next = 7;
                        return (0,_functions__WEBPACK_IMPORTED_MODULE_1__.fetchData)("https://jsonplaceholder.typicode.com/posts/".concat(postId, "/comments"), data, 'POST');
                      case 7:
                        res = _context3.sent;
                        response = res.data;
                        commentList = {
