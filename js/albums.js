      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 3;
            return fetchDataAlbums(leftColumn);
          case 3:
...
function fetchDataAlbums(_x) {
  return _fetchDataAlbums.apply(this, arguments);
}
        ...
        switch (_context2.prev = _context2.next) {
          ...
          case 10:
            data.map(function (album) {
              ...
              var photoes = album.photos.map(function (photo) {
                return photo;
              });
...
function generateAlbumsList(albumsDataToDom, leftColumn) {
  var obj = {
    header: "Album title: <a href=\"album.html?albumid=".concat(albumsDataToDom.albumId, "\">").concat((0,_functions__WEBPACK_IMPORTED_MODULE_1__.firstLetterToUpperCase)(albumsDataToDom.title), "</a>"),
    list: ["User name: ".concat(albumsDataToDom.userName), "<img src=\"".concat(albumsDataToDom.photoAddress, "\">(").concat(albumsDataToDom.numberOfPhotos, ")")]
  };
...
function generateAllPhotosList(photoes) {
  photoes.map(function (photo) {
    var galeryBox = document.querySelector('#my-gallery');
