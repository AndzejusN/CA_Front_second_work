...
function setDataSelect() {
  return _setDataSelect.apply(this, arguments);
}
function _setDataSelect() {
  _setDataSelect = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var select, data;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
...
function getDataForm() {
  ...
  form.addEventListener('submit', function (event) {
    ...
    var postName = event.target.elements['post-name'].value;
    var postBody = event.target.elements['post-body'].value;
    var selectUserId = event.target.elements['user-id'].value;
    var data = {
      title: postName,
      body: postBody,
      userId: selectUserId
...
function _postData() {
  _postData = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(data) {
    var json, container, userData, rigthColumn, response;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return (0,_functions__WEBPACK_IMPORTED_MODULE_1__.fetchData)('https://jsonplaceholder.typicode.com/posts', {
              title: data.title,
              body: data.body,
              userId: data.userId
            });
          case 2:
            ...
            _context2.next = 6;
            return (0,_functions__WEBPACK_IMPORTED_MODULE_1__.fetchData)("https://jsonplaceholder.typicode.com/users/".concat(json.userId));
          case 6:
            userData = _context2.sent;
            rigthColumn = document.querySelector('.right-column');
            rigthColumn.innerHTML = '';
            response = document.createElement('h6');
            response.innerText = "User name:  ".concat(userData.name, ";\n                          Post title: ").concat((0,_functions__WEBPACK_IMPORTED_MODULE_1__.firstLetterToUpperCase)(json.title), ";\n                          Post text: ").concat((0,_functions__WEBPACK_IMPORTED_MODULE_1__.firstLetterToUpperCase)(json.body), ";");
