...
function init() {
  var inputSearch = (0,_functions__WEBPACK_IMPORTED_MODULE_1__.getSearchPhrase)('albumid');
...
function _getAlbum() {
  _getAlbum = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var id,
      res,
      album,
      albumsDataToDom,
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            id = _args.length > 0 && _args[0] !== undefined ? _args[0] : 1;
            _context.next = 3;
            return (0,_functions__WEBPACK_IMPORTED_MODULE_1__.fetchData)("https://jsonplaceholder.typicode.com/albums/".concat(id, "/?_expand=user"));
          case 3:
            res = _context.sent;
            album = res.data;
            albumsDataToDom = {
...
function generateAlbumsList(albumsDataToDom) {
  ...
  var obj = {
    header: "Album title: ".concat((0,_functions__WEBPACK_IMPORTED_MODULE_1__.firstLetterToUpperCase)(albumsDataToDom.title)),
    list: ["User id: ".concat(albumsDataToDom.userId), "Album id: ".concat(albumsDataToDom.albumId), "User name: <a href=\"user.html?userid=".concat(albumsDataToDom.userId, "\"> ").concat(albumsDataToDom.userName, "</a>")]
  };
